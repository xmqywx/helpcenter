...
<WarningBox>
💡 If you did not receive the verification email, please check your spam or junk folder. If it's not there, you can request a new verification email from the CoinByte login page or refer to <strong><a href="/docs/account-security/faq/what-if-email-code-not-received">What if Email Code Not Received</a></strong>.
</WarningBox>
