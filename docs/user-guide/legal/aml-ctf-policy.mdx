...
We use automated and manual transaction monitoring to detect suspicious activity. Our monitoring combines multiple data sources and analytical tools, including:

- <strong>Sumsub:</strong> Used for document verification, biometric checks, duplicate account detection, fiat transaction profiling, behavioural risk scoring, and anomaly detection.

- <strong>Chainalysis KYT:</strong> Provides blockchain transaction monitoring, wallet address risk profiling, sanctions exposure detection, typology analysis, and identification of mixers/tumblers, darknet, and sanctioned entities.

- <strong>Official government and international lists:</strong> Screening against AUSTRAC, DFAT, UN, OFAC, and other regulatory databases for sanctions and Politically Exposed Persons (PEPs).
...
- <strong>Low-risk clients:</strong> periodic KYC review at least annually.

- <strong>Medium-risk clients:</strong> periodic KYC review every 6 months.

- <strong>High-risk clients:</strong> not onboarded; if identified post-onboarding, account will be subject to immediate review and potential suspension.
