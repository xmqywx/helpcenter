...
<RoundStepList>
<li>Select the <strong>send</strong> <img src="https://efile.coinbyte.com.au/20260706_sent.png"  alt="Personal Center" width="70" /> icon on the Home screen.</li>
<li>Select the <strong>Cryptocurrency</strong> you wish to withdraw.</li>
<li>Enter the <strong>amount</strong> you wish to withdraw and select your preferred <strong>network</strong>.</li>
...
<li><strong>Review your withdrawal details</strong>, then tap Confirm.</li>
