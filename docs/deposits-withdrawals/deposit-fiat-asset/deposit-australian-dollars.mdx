...
<CoinByteButton text="Deposit AUD" link="https://coinbyte.com.au/en-us/user/balances/deposit/?currency=aud&type=bank" />

- **Direct deposit/Bank transfer**: please refer to <a href="/docs/deposits-withdrawals/deposit-fiat-asset/direct-deposit"><strong>Direct deposit</strong></a>  
- **PayID/Osko**: please refer to <a href="/docs/deposits-withdrawals/deposit-fiat-asset/payid-osko-deposits-aud-only"><strong>PayID/Osko</strong></a>
...
<InfoBox>
<strong>Please Note:</strong> CoinByte did not charge any fee for deposits, but your financial institution may charge a fee.
</InfoBox>
