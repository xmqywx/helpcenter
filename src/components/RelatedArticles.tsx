  ...
  const fallbackData: Record<string, Document[]> = {
    'account-security': [
      {
        ...
        permalink: '/docs/account-security/create-coinbyte-account/register-a-coinbyte-account',
      },
      {
        id: 'account-security/two-factor-authentication',
        title: 'Set up Two-Factor Authentication',
        permalink: '/docs/account-security/verification-and-security/set-up-two-factor-authentication',
      },
      {
        id: 'account-security/kyc-verification',
        title: 'Complete Your KYC Verification',
        permalink: '/docs/account-security/verification-and-security/complete-your-KYC-verification-(individual-account)',
      },
      {
        id: 'account-security/verify-email',
        title: 'Verify Your Email',
        permalink: '/docs/account-security/verification-and-security/verify-your-email',
      },
      {
        id: 'account-security/verify-phone',
        title: 'Verify Your Phone Number',
        permalink: '/docs/account-security/verification-and-security/verify-your-phone-number',
      },
      {
        id: 'account-security/password-reset',
        title: 'Reset or Change Your Password',
        permalink: '/docs/account-security/update-details/reset-or-change-your-password',
      }
    ],
    'trading': [
      {
        ...
        title: 'Spot Trading',
        permalink: '/docs/trading/exchange/spot-trade',
      },
      {
        id: 'trading/market-order',
        title: 'Market Orders',
        permalink: '/docs/trading/exchange/market-order',
      },
      {
        id: 'trading/limit-order',
        title: 'Limit Orders',
        permalink: '/docs/trading/exchange/limit-order',
      },
      {
        id: 'trading/instant-buy-crypto',
        title: 'Instant Buy Crypto',
        permalink: '/docs/trading/instant-buy-sell/instant-buy-crypto',
      },
      {
        id: 'trading/instant-sell-crypto',
        title: 'Instant Sell Crypto',
        permalink: '/docs/trading/instant-buy-sell/instant-sell-crypto',
      },
      {
        id: 'trading/manage-your-trade',
        title: 'Manage Your Trade',
        permalink: '/docs/trading/manage-your-trade',
      }
    ],
    'spot-trade': [
      {
      ...
      },
      {
        ...
        permalink: '/docs/trading/FAQ/spread',
      }
    ],
    'deposits-withdrawals': [
      {
        ...
        permalink: '/docs/deposits-withdrawals/deposit-crypto',
      },
      {
        id: 'deposits-withdrawals/withdraw-crypto',
        title: 'Withdraw Crypto',
        permalink: '/docs/deposits-withdrawals/withdraw-crypto',
      },
      {
        id: 'deposits-withdrawals/deposit-fiat',
        title: 'Deposit Fiat Currency',
        permalink: '/docs/deposits-withdrawals/deposit-fiat-asset',
      },
      {
        id: 'deposits-withdrawals/withdraw-fiat',
        title: 'Withdraw Fiat Currency',
        permalink: '/docs/deposits-withdrawals/withdraw-fiat-asset',
      },
      {
        id: 'deposits-withdrawals/fees',
        title: 'Deposit & Withdrawal Fees',
        permalink: '/docs/deposits-withdrawals/FAQ/crypto-asset-deposit-withdrawal-fee',
      },
      {
        id: 'deposits-withdrawals/link-bank-account',
        title: 'Link a Bank Account',
        permalink: '/docs/deposits-withdrawals/withdraw-fiat-asset/link-a-bank-account',
      }
    ],
    'deposits-and-withdrawals': [
      ...
      },
      {
        ...
        permalink: '/docs/deposits-withdrawals/deposit-fiat-asset/direct-deposit',
      },
      {
        id: 'deposits-withdrawals/fees',
        title: 'Deposit & Withdrawal Fees',
    ...
    'deposit-crypto': [
      {
        ...
        permalink: '/docs/deposits-withdrawals/deposit-crypto/deposit-crypto',
      },
      {
        id: 'deposits-withdrawals/deposit-from-exchange',
        title: 'Deposit from Other Exchange or Wallet',
        permalink: '/docs/deposits-withdrawals/deposit-crypto/deposit-from-other-exchange-or-wallet',
      },
      {
        id: 'deposits-withdrawals/update-deposit-address',
        title: 'Update Your CoinByte Deposit Address',
        permalink: '/docs/deposits-withdrawals/deposit-crypto/update-your-coinByte-deposit-address',
      },
      {
        id: 'deposits-withdrawals/network-selection',
        title: 'Selecting a Network for Crypto Transfer',
        permalink: '/docs/deposits-withdrawals/withdraw-crypto/Selecting-a-network-for-crypto-transfer',
      }
    ],
    'network-and-fees': [
      {
      ...
      },
      {
        ...
        permalink: '/docs/deposits-withdrawals/withdraw-crypto/withdrawal-network-fees',
      },
      {
    ...
    'user-guide': [
      {
        ...
        permalink: '/docs/user-guide/about-coinbyte',
      },
      {
        id: 'user-guide/trading-fee-structure',
        title: 'Trading Fee Structure',
        permalink: '/docs/user-guide/about-coinbyte/trading-fee-structure',
      },
      {
        id: 'user-guide/contact-team',
        title: 'Contact Our Team',
        permalink: '/docs/user-guide/about-coinbyte/Contact-to-our-team',
      },
      {
        id: 'user-guide/tools',
        title: 'Tools & Features',
        permalink: '/docs/user-guide/tools',
      }
    ],
    'legal': [
      {
        ...
        permalink: '/docs/user-guide/legal/terms-of-service',
      },
      {
        id: 'user-guide/legal/privacy-notice',
        title: 'Privacy Notice',
        permalink: '/docs/user-guide/legal/privacy-notice',
      },
      {
        id: 'user-guide/legal/risk-disclosure',
        title: 'Risk Disclosure Statement',
        permalink: '/docs/user-guide/legal/risk-disclosure-statement',
      },
      {
        id: 'user-guide/legal/aml-ctf-policy',
        title: 'AML/CTF Policy',
        permalink: '/docs/user-guide/legal/aml-ctf-policy',
      },
      {
        id: 'user-guide/legal/law-enforcement',
        title: 'Law Enforcement Request Guide',
        permalink: '/docs/user-guide/legal/law-enforcement-request-guide',
      }
    ],
    'tools': [
      {
        ...
        permalink: '/docs/user-guide/tools/app-notification',
      },
      {
        id: 'user-guide/tools/transaction-history',
        title: 'Transaction History',
        permalink: '/docs/user-guide/tools/transaction-history',
      }
    ],
    'account-management': [
      {
      ...
      },
      {
        ...
        permalink: '/docs/account-security/update-details/change-your-phone-number',
      },
      {
        id: 'account-security/password-reset',
        title: 'Reset or Change Your Password',
      ...
      },
      {
        ...
        permalink: '/docs/account-security/verification-and-security/manage-login-and-security-history',
      }
    ]
  };
